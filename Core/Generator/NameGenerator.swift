...
struct NameGenerator {
    ...
    static func fixClassName(_ className: String, _ prefix: String?, _ isTopLevelObject: Bool, _ rescursiveName: String = "") -> String {
        ...
        if !rescursiveName.isEmpty {
            var prefix = rescursiveName
            prefix.uppercaseFirst()
